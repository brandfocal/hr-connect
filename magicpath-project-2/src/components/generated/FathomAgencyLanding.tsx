...
import { ArrowRight, Plus, Minus, ChevronLeft, ChevronRight, ArrowUp, Mail, Phone, MapPin, Linkedin, Twitter, Menu, X } from "lucide-react";
...
const ABOUT_BULLETS = ["100% Black Woman-Owned Human Capital Consultancy", "Specialist expertise in Human Capital Advisory, Leadership Development and Talent Solutions", "Extensive experience delivering customised learning and organisational development programmes", "Proven capability in executive search, talent acquisition and workforce solutions", "Trusted partner to organisations across the public, private and development sectors", "Expertise in designing and delivering premium executive conferences, leadership summits, learning academies and customised corporate experiences", "Multidisciplinary team of experienced consultants, facilitators, executive coaches and talent specialists", "Bespoke, commercially driven solutions aligned to each client's strategic objectives", "Committed to developing leaders, connecting exceptional talent and enabling sustainable organisational growth"];
...
const WHY_BULLETS = ["Strategic Human Capital Expertise", "Executive-Level Advisory", "Tailor-Made Solutions", "Industry-Leading Facilitators", "High-Impact Learning Experiences", "Premium Corporate Events", "Proven Talent Solutions", "Leadership Excellence", "Organisational Transformation", "Sustainable Business Growth"];
const INDUSTRIES = ["Financial Services", "Government & Public Sector", "Mining & Resources", "Infrastructure", "Manufacturing", "Retail & FMCG", "Healthcare", "Education", "ICT & Telecommunications", "Professional Services", "Energy", "Development Sector"];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-12 lg:gap-24">
          <div className="lg:col-span-5">
            ...
            once: true
              ...
              <img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=1200&q=85&auto=format&fit=crop" alt="HR Connect — people-centred leadership and organisational excellence" className="w-full h-full object-cover" />
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            ...
            <div className="space-y-0">
              <p className="text-[9px] uppercase tracking-[0.3em] font-bold text-fathom-terracotta mb-6">
                We deliver
              </p>
              {WHY_BULLETS.map((bullet, i) => <motion.div key={bullet} className="py-4 md:py-5 border-t border-white/10 flex items-center justify-between group cursor-default" initial={{
              opacity: 0,
              y: 10
            }} whileInView={{
              opacity: 1,
              ...
              once: true
                  ...
                  <span className="text-sm md:text-base font-serif text-white/75 group-hover:text-white transition-colors">
                    {bullet}
                  </span>
                  <ArrowRight className="w-3.5 h-3.5 text-fathom-terracotta opacity-0 group-hover:opacity-100 transition-opacity shrink-0" />
                </motion.div>)}
      ...
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 lg:gap-24 items-center">
          ...
          delay: 0.2
            ...
            <p className="text-[10px] uppercase tracking-[0.25em] font-bold text-fathom-graphite/60 mb-5">
              We work across diverse sectors, including:
            </p>
            <div className="flex flex-wrap gap-2.5 md:gap-3">
              {INDUSTRIES.map((industry, i) => <motion.span key={industry} initial={{
              opacity: 0,
              scale: 0.92
            }} whileInView={{
              opacity: 1,
              ...
              delay: i * 0.05,
              ease: [0.16, 1, 0.3, 1]
            }} className="inline-flex items-center rounded-full px-4 py-2 text-[11px] uppercase tracking-[0.18em] font-bold cursor-default select-none border border-[#B5654A] text-[#B5654A] bg-[#EDE8DC] hover:bg-[#B5654A] hover:text-white transition-all duration-250">
                  {industry}
                </motion.span>)}
            </div>
          </motion.div>
      ...
      <div className="flex-1 flex flex-col justify-center px-6 sm:px-10 md:px-14 lg:px-16 py-14 md:py-20 lg:py-28">
        ...
        once: true
          ...
          <motion.div variants={FADE_UP_VARIANTS} className="space-y-4 md:space-y-5 text-white/55 text-sm leading-relaxed font-light">
            ...
            <p>
              As a passionate advocate for leadership excellence, women's advancement and workforce transformation, Lesego believes that people remain every organisation's greatest competitive advantage.
            </p>
          </motion.div>
              ...
              <motion.div variants={FADE_UP_VARIANTS} className="flex flex-col gap-6 md:gap-8">
                <div className="flex items-start gap-4 md:gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-white/40 text-sm md:text-base italic">[email]</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 md:gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-white/40 text-sm md:text-base italic">[phone]</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 md:gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-white/40 text-sm md:text-base italic">[location]</p>
                  </div>
                </div>
              </motion.div>
            </div>
